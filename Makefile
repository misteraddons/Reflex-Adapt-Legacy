...
# #85: Nintendo-only combo (NES/SNES/VB, N64, GameCube, Wii)
# NOTE: SNES multitap does not fit in MPG flash with this full Nintendo set.
MPGCombo14.FLAGS = -DENABLE_REFLEX_SNES -DSNES_ENABLE_VBOY -DENABLE_REFLEX_N64 -DENABLE_N64_ANALOG_MAX=80 -DENABLE_REFLEX_GAMECUBE -DENABLE_REFLEX_WII
# #83: SNES/NES + GEN/SAT + N64 + PCE
MPGCombo15.FLAGS = -DENABLE_REFLEX_SNES -DSNES_ENABLE_VBOY -DENABLE_REFLEX_SATURN -DENABLE_REFLEX_N64 -DENABLE_N64_ANALOG_MAX=80 -DENABLE_REFLEX_PCE
# #82: Wii + GEN/SAT
